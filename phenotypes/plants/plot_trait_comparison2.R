...
# 1. Prepare data ----
plants_n <- plants %>%
    filter(population != "control", exp_plant == "sativa", gradient == "urbanization") %>%
...
p <- plot_boxes(plants, "urbanization", "sativa")
ggsave(paste0(folder_phenotypes, "plants/01b-sativa_traits.png"), p, width = 8, height = 5)
