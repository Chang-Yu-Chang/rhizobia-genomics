---
title: "growth curve batch 3 at 35C"
output: pdf_document
header-includes:
    - \usepackage{fancyhdr}
    - \pagestyle{fancy}
...
# Report the layout
write_csv(gc_plate, paste0(folder_data, "raw/growth_curve3/gc_plate.csv"))
```
...
mi <- read_csv(paste0(folder_data, "raw/growth_curve2/inocula_before_standardization.csv"), show_col_types = F)
