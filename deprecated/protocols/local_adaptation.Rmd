...
- Germination rate may vary. If aiming for ~100 plants in the treatments, scarify double amount of seeds if possible (~200 seeds)
- 


## 1. Rhizobia isolation

- Isolate rhizobia from H and L sites
- Refer to the protocol

## 2. Seed scarification and planting

- Count seeds
- Prepare autoclaved sand in pots
    - terface to sand = 1:4
- Plant seedlings. Refer to the protocol 

## 3. Rhizobia inoculation


20221115
- Make TY liquid medium 
- Inoculate six rhizobia strains into 50mL of TY medium
- Incubate culture in 250mL flasks at 30C with shaking
- Six rhizobia strains -> not all of them are rhizobia 
    - H1M2R3
    - H3M1R1
    - H4M1R1
    - L1M3R2
...
20221118
- Standardize the OD to 0.1 at 600 nm. Refer to the protocol
- Use the script 


## 4. Harvesting the inocaultion
...
- [ ] Dissolve pellets in $180 \mu L$ of PBS and transfer to DNeasy microtube plates.
- [ ] Add $25 \mu L$ proteinase K and $200 \mu L$ Buffer AL. Seal the plate with caps and mix by vortexing. Incubate at 56C for 30 min.
- [ ] Add $200 \mu L$ pure ethanol. Seal the plate with caps and mix thoroughly by vortexing. 
...
- [ ] Add $100 \mu L$ Buffer AE to each sample, and seal the DNeasy 96 plates with new AirPore Tape Sheets (provided). Incubate for 1 min at room temperature (15–25°C). Centrifuge for 2 min at 6000 rpm.
