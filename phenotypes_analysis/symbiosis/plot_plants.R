...
plants <- read_csv(paste0(folder_phenotypes, "symbiosis/plants.csv"))
plants_inoculated <- plants %>% filter(exp_id != "control")
...
length(unique(plants$id)) # 251 plants
length(unique(plants$exp_id)) # 14 rhizobia + 1 control
