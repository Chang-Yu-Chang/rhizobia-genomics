...
list_va[[10]] <- plot_pair2(tra = "dry_weight_mg", pop = "VA", y_axis = "shoot biomass (mg)")
list_va[[11]] <- plot_pair2(tra = "nodule_number", pop = "VA", y_axis = "# of nodules")
list_va[[12]] <- plot_pair2(tra = "root_weight_mg", pop = "VA", y_axis = "root biomass (mg)")

p <- plot_grid(plotlist = list_va[1:12], nrow = 4, align = "vh", axis = "lrbt", labels = c("A", rep("", 8), "B", "", ""))
ggsave(here::here("plots/FigS6.png"), p, width = 10, height = 12)
