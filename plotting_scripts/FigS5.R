...
tra = "r_30c"
pop = "VA"
y_axis = expression(r~at~30*degree*C~(1/hr))
plot_pair <- function (tra = "r_30c", pop = "VA", y_axis = expression(r~at~30*degree*C~(1/hr))) {
    ...
    min_value <- min(igcl$value)
    max_value <- max(igcl$value)
    p2 <- igcl %>%
        ggplot() +
        ...
        geom_text(data = sigs, aes(label = sig), x = 1.5, y = max_value*1.1, vjust = -1) +
        scale_fill_manual(values = site_group_colors) +
        scale_x_discrete(expand = c(0,0)) +
        scale_y_continuous(limits = c(min_value, max_value*1.3)) +
...
list_va[[1]] <- plot_pair(tra = "r_25c", pop = "VA", y_axis = expression(r~at~25*degree*C~(1/hr)))
list_va[[2]] <- plot_pair(tra = "lag_25c", pop = "VA", y_axis = expression(lag~at~25*degree*C~(hr)))
list_va[[3]] <- plot_pair(tra = "maxOD_25c", pop = "VA", y_axis = expression(maxOD~at~25*degree*C))
list_va[[4]] <- plot_pair(tra = "r_30c", pop = "VA", y_axis = expression(r~at~30*degree*C~(1/hr)))
list_va[[5]] <- plot_pair(tra = "lag_30c", pop = "VA", y_axis = expression(lag~at~30*degree*C~(hr)))
list_va[[6]] <- plot_pair(tra = "maxOD_30c", pop = "VA", y_axis = expression(maxOD~at~30*degree*C))
list_va[[7]] <- plot_pair(tra = "r_35c", pop = "VA", y_axis = expression(r~at~35*degree*C~(1/hr)))
list_va[[8]] <- plot_pair(tra = "lag_35c", pop = "VA", y_axis = expression(lag~at~35*degree*C~(hr)))
list_va[[9]] <- plot_pair(tra = "maxOD_35c", pop = "VA", y_axis = expression(maxOD~at~35*degree*C))

plot_grid(plotlist = list_va[1:9])


list_va[[10]] <- plot_pair(tra = "r_30c", pop = "VA", y_axis = expression(r~at~30*degree*C~(1/hr)))
list_va[[11]] <- plot_pair(tra = "r_30c", pop = "VA", y_axis = expression(r~at~30*degree*C~(1/hr)))
list_va[[12]] <- plot_pair(tra = "r_30c", pop = "VA", y_axis = expression(r~at~30*degree*C~(1/hr)))
