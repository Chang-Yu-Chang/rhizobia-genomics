...
ft2 <- tb_tidied2 %>%
    ...
    flextable() %>%
    # Align and spacing
    merge_v(j = c("Gradient", "Type", "Trait")) %>%
    merge_at(j = "Model", i = 1:2) %>%
    merge_at(j = "Model", i = 3:4) %>%
    merge_at(j = "Model", i = 5:6) %>%
    merge_at(j = "Model", i = 7:8) %>%
    merge_at(j = "Model", i = 9:10) %>%
    merge_at(j = "Model", i = 11:12) %>%
