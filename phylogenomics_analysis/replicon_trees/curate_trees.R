...
for (i in 5:8) tbtr2$tr[i] <- list(read.tree(paste0(folder_data, "phylogenomics_analysis/replicon_trees/", set_name, "/", tbtr2$replicon_type[i], "/tr_gpa.tree")))
tbtr2 <- filter(tbtr2, !(tr_type == "core" & replicon_type == "pAcce"))
