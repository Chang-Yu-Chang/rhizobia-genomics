...
tb_month <- read_csv(paste0(folder_data, "temp/05-tb_month.csv"))
...
ggsave(paste0(folder_data, "temp/05a-01-daily_t.png"), p, width = 10, height = 8)
...
ggsave(paste0(folder_data, "temp/05a-02-H_vs_L.png"), p, width = 10, height = 8)
...
ggsave(paste0(folder_data, "temp/05a-03-resample_difference_HL.png"), p, width = 4, height = 4)
