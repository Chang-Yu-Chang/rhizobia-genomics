...
list_strains <- unique(gc_plate$strain)
...
ggsave(paste0(folder_data, "temp/04d-01-gc_raw.png"), p, width = 6, height = 5)
...
ggsave(paste0(folder_data, "temp/04d-02-gc_raw_grid.png"), p, width = 20, height = 15)
...
ggsave(paste0(folder_data, "temp/04d-03-gc_mean.png"), p, width = 10, height = 6)
...
ggsave(paste0(folder_data, "temp/04d-04-gc_trait.png"), p, width = 6, height = 10)
