...
write_csv(site_cd, paste0(folder_data, "temp/05-site_cd.csv"))
...
write_csv(dml, paste0(folder_data, "temp/05-dml.csv"))
...
write_csv(diff_tmax, paste0(folder_data, "temp/05-diff_tmax.csv"))
...
write_csv(diff_tmin, paste0(folder_data, "temp/05-diff_tmin.csv"))
...
write_csv(tb_summer, paste0(folder_data, "temp/05-tb_summer.csv"))
write_csv(tb_season, paste0(folder_data, "temp/05-tb_season.csv"))
write_csv(tb_month, paste0(folder_data, "temp/05-tb_month.csv"))
