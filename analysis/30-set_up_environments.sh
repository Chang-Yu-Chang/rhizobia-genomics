...
# 0.2 Install miniconda for macOS
mkdir -p ~/miniconda3
curl https://repo.anaconda.com/miniconda/Miniconda3-py311_23.5.2-0-MacOSX-arm64.sh -o ~/miniconda3/miniconda.sh
zsh ~/miniconda3/miniconda.sh -b -u -p ~/miniconda3
rm -rf ~/miniconda3/miniconda.sh
~/miniconda3/bin/conda init zsh

conda --version # this should be conda 23.5.2

# 0.3 Create a conda env for osx-64 called intel_env
...
# 0.4 Install mamba under the created conda env intel_env
