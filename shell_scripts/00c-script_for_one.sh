...
mkdir -p "$folder_temp_result/$sample_id/45-plasforest"
...
log45="$folder_temp_result/$sample_id/logs/45-plasforest.log"
...
# 10. plasforest
medaka_consensus="$folder_temp_result/$sample_id/04-medaka/consensus.fasta"
plasforest_folder="$folder_temp_result/$sample_id/45-plasforest"
