...
roary -f roary -e -n -i 95 -cd 99 -r -s gff/*.gff
...
# roary -f roary2 -e -n -i 75 -cd 99 -r -s gff/*.gff
# roary -f roary3 -e -n -i 50 -cd 99 -r -s gff/*.gff
# roary -f roary4 -e -n -i 95 -cd 90 -r -s gff/*.gff
