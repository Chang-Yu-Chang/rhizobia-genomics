#' This script aggregates the qc results of assemblies, including quast, checkm, and busco
...
write_csv(flye, paste0(folder_data, "genomics/qcs/flye.csv"))
...
write_csv(quast, paste0(folder_data, "genomics/qcs/quast.csv"))
...
write_csv(busco, paste0(folder_data, "genomics/qcs/busco.csv"))
...
write_csv(checkm, paste0(folder_data, "genomics/qcs/checkm.csv"))
